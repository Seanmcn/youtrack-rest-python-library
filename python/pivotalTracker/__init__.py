...
EXISTING_FIELDS = ['numberInProject', 'summary', 'description', 'created', 'updated']



class PivotalTrackerException(Exception):
    def __init__(self, *args, **kwargs):
        super(PivotalTrackerException, self).__init__(*args, **kwargs)